...
import {downloadAttachFile, formatDate, getUserNickName} from "../../common/CommonUtils";
import {BOARD_DELETE, BOARD_UPDATE, BOARD_WRITE, ROLE_ADMIN} from "../../common/Constants";
                ...
                {articles &&
                    articles.map((post, index) => (
                        <tr key={index}>
                            ...
                            <td>
                                {((auth && post.member.userId === auth.userId) || (auth && auth.userType === ROLE_ADMIN)) &&
                                    <>
