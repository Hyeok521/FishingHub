  ...
  useEffect(() => {
    ...
    script.onload = () => {
      window.kakao.maps.load(() => {
        ...
        const locations = [
          { name: "애월방파제", lat: 33.46875, lng: 126.3238 },
          { name: "도두방파제", lat: 33.50874, lng: 126.4638 },
          { name: "서부두방파제", lat: 33.52282, lng: 126.5302 },
          { name: "김녕방파제", lat: 33.56067, lng: 126.7389 },
          { name: "위미방파제", lat: 33.26826, lng: 126.6633 },
          { name: "서귀포 범섬", lat: 33.21784, lng: 126.5168 },
          { name: "제주도 형제섬", lat: 33.20999, lng: 126.3143 },
        ];
