  ...
  useEffect(() => {
    ...
    script.onload = () => {
      window.kakao.maps.load(() => {
        ...
        const locations = [
          { name: "외연도", lat: 36.23038, lng: 126.0824 },
          { name: "어청도", lat: 36.12013, lng: 125.9734 },
          { name: "녹도리", lat: 36.30238, lng: 126.2591 },
          { name: "부사방조제", lat: 36.1855, lng: 126.5241 },
          { name: "마량방파제", lat: 36.129, lng: 126.5074 },
          { name: "개야도", lat: 36.04059, lng: 126.5503 },
          { name: "말도", lat: 35.85751, lng: 126.3216 },
          { name: "야미도선착장", lat: 35.84084, lng: 126.4883 },
          { name: "격포방파제", lat: 35.62335, lng: 126.4639 },
          { name: "석금방파제", lat: 35.56926, lng: 126.2683 },
        ];
