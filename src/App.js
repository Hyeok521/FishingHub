    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route
                    path="/PasswordSearch"
                    element={<PublicRoute children={<PasswordSearch/>} notLogin={true}/>}
                />
                ...
                />
                <Route path="/Faq" element={<PublicRoute children={<Board boardMasterId={5}/>}/>}/>
                <Route path="/QNA" element={<PublicRoute children={<Board boardMasterId={6}/>}/>}/>
                {/* 게시판 E */}

                {/* 회원정보 수정 */}
                <Route path="/Edit" element={<PrivateRoute children={<Edit authenticate={authenticate}/>}/>}/>
